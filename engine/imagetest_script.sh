...
then
    sed -i 's/.*TEST_SUITES.*/TEST_SUITES = "dummy1 dummy2"/' /home/smith/projects/poky/build/conf/local.conf
else
    echo 'TEST_SUITES = "dummy1 dummy2"' >> /home/smith/projects/poky/build/conf/local.conf
fi
